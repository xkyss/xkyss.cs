...
public static class GlobalHotkey
{
    ...
    public const int OverlayHotkeyId = OverlayHotkeyIdConst;
    ...
    /// </summary>
    public static bool Register(IntPtr hWnd, string hotkey)
    {
    ...
    public static void Unregister(IntPtr hWnd) => UnregisterHotKey(hWnd, OverlayHotkeyId);
}
